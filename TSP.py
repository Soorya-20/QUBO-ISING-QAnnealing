...
print("QMatrix of size {}x{} was created \n".format(sqrt(len(Q)),sqrt(len(Q))))
...
print('-' * 90)
print('{:>20s}{:>40s}{:^30s}'.format('0s','1s','Energy'))
print('-' * 90)
...
for sample, E in S.data(fields=['sample','energy']):
    ...
    print('{:>35s}{:>25s}{:^20s}'.format(str(S0),str(S1),str(E)))
